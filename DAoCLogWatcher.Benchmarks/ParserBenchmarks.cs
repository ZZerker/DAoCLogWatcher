...
public class ParserBenchmarks
{
	...
	[Benchmark(Description = "String.Contains pre-filter (valid line)")]
	public bool StringContains_Valid()
	{
		return this.campaignQuestLine.Contains("realm point");
	}

	[Benchmark(Description = "String.Contains pre-filter (invalid line)")]
	public bool StringContains_Invalid()
	{
