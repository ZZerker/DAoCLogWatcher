...
public sealed class RealmPointSummaryTests
{
    ...
    public void Percentages_ShouldSumTo100_WhenAllRPsAccountedFor()
    {
        ...
        // Act
        var totalPercentage = summary.PlayerKillsPercentage +
    ...
    public void Percentages_SumTo100_ForVariousValidDistributions(
        int total, int kills, int quests, int ticks, int siege, int assault, int support, int relic, int unknown)
    {
        // Arrange
        var summary = new RealmPointSummary
        {
    ...
    public void Integration_RealisticScenario_PercentagesAreValid(
        int total, int kills, int quests, int ticks, int siege, int assault, int support, int relic, int unknown)
    {
        // Arrange
        var summary = new RealmPointSummary
    ...
    public void BugDetection_IndividualRPsSumToTotal_ShouldBeEnforced()
    {
        ...
        sumOfIndividualRPs.Should().Be(summary.TotalRealmPoints,
            "Individual RP values should sum exactly to TotalRealmPoints. " +
            "If this fails, there's a bug in ProcessLogLine accumulation logic.");
    }
}
